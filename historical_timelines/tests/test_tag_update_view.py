...
class TagUpdateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user0_hist_timeline_id = users[0]["historical_timelines"][0]["id"]
        ...
        cls.user1_hist_timeline_id = users[1]["historical_timelines"][0]["id"]
    ...
    def test_view_url_exists_at_desired_location(self):
        ...
        response = self.client.get(
            f"/timelines/historical/{timeline_id}/tag/{tag_id}/update/"
        )
    ...
    def test_view_url_accessible_by_name(self):
        ...
        response = self.client.get(
            reverse(
                "historical_timelines:tag-update",
                kwargs={
    ...
    def test_uses_correct_template(self):
        ...
        self.assertEqual(str(response.context["user"]), self.user0.username)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "historical_timelines/tag_edit.html")
