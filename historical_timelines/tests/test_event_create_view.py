...
class AgeEventCreateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.new_historical_event_data = {
            "historical_timeline": cls.user0_hist_timeline_id,
            "title": "New Test Historical Event",
    ...
    def test_view_url_exists_at_desired_location(self):
        ...
        response = self.client.get(
            f"/timelines/historical/{self.user0_hist_timeline_id}/event/add/"
        )
    ...
    def test_view_url_accessible_by_name(self):
        ...
        response = self.client.get(
            reverse(
                "historical_timelines:event-add",
                kwargs={
    ...
    def test_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, "historical_timelines/event_add.html"
        )
    ...
    def test_historical_event_added(self):
        ...
        response = self.client.post(
            ...
            data=self.new_historical_event_data,
            follow=True,
        )
        self.assertEqual(str(response.context["user"]), self.user0.username)
        self.assertEqual(response.status_code, 200)
