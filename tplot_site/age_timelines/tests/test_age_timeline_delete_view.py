...
class AgeTimelineDeleteViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(
            response,
            f"/accounts/login/?next=/timelines/age/{self.user0_age_timeline_id}/delete/"
        )
    ...
    def test_age_timeline_deleted(self):
        ...
        expected_age_timelines = self.TIMELINES_PER_USER - 1
        self.assertEqual(len(age_timelines), expected_age_timelines)
