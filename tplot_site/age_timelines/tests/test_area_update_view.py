...
class AreaUpdateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(
            response,
            f"/accounts/login/?next=/timelines/age/{self.user0_age_timeline_id}/area/{self.user0_event_area_id}/update/"
        )
    ...
    def test_view_url_exists_at_desired_location(self):
        ...
        response = self.client.get(
            f"/timelines/age/{self.user0_age_timeline_id}/area/{self.user0_event_area_id}/update/"
        )
    ...
    def test_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response,
            "age_timelines/area_edit_form.html"
        )
    ...
    def test_event_area_updated(self):
        ...
        updated_name = 'Updated Event Area'
        data = {
        ...
        self.assertEqual(area_event.name, updated_name)
