...
class TagUpdateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user0_tag_id = users[0]["scientific_timelines"][0]["tag_ids"][0]
        cls.user1_scientific_timeline_id = users[1]["scientific_timelines"][0][
            "id"
        ]
        cls.user1_tag_id = users[1]["scientific_timelines"][0]["tag_ids"][0]
    ...
    def test_view_url_exists_at_desired_location(self):
        ...
        response = self.client.get(
            f"/timelines/scientific/{timeline_id}/tag/{tag_id}/update/"
        )
    ...
    def test_view_url_accessible_by_name(self):
        ...
        response = self.client.get(
            reverse(
                "scientific_timelines:tag-update",
                kwargs={
    ...
    def test_uses_correct_template(self):
        ...
        self.assertEqual(str(response.context["user"]), self.user0.username)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "scientific_timelines/tag_edit.html")
